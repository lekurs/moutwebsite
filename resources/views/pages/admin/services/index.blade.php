            ...
            <table class="table table-striped custom-table mb-0 datatable dataTable no-footer mb-4 mt-4" id="services">
                ...
                @foreach($services as $service)
                    <tr>
                        ...
                        <td><a href="{{ route('services.show', $service->id) }}" class="txt">{{ $service->libelle }}</a></td>
                        <td>{!! $service->icon !!}</td>
                        ...
                        <td>
                            <div class="dropdown-mout dropdown-mout-table">
                                ...
                                <div class="dropdown-menu-mout dropdown-menu-mout-table dropdown-mout-status" x-placement="bottom-end" style="position: absolute; transform: translate3d(-17px, 31px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item" href="{{ route('services.status', $service->id) }}"><i class="fa fa-dot-circle-o text-success"></i> Activé</a>
                                    <a class="dropdown-item" href="{{ route('services.status', $service->id) }}"><i class="fa fa-dot-circle-o text-danger"></i> Désactivé</a>
                                </div>
                            </div>
                        </td>
                        <td class="text-right">
                            <div class="dropdown-mout dropdown-mout-table dropdown-mout-status">
                                ...
                                <div class="dropdown-menu-mout dropdown-menu-mout-table">
                                    <a class="dropdown-item" href="{{ route('services.edit', $service->id) }}" data-id=""><i class="fal fa-pen"></i> Modifier</a>
                                    <a class="dropdown-item" href="{{ route('services.destroy', $service->id) }}" data-id=""><i class="fal fa-trash"></i> Supprimer</a>
                                </div>
                            </div>
                        </td>
                    </tr>
